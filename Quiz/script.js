const delayTime = 1500; // wachttijd voor de volgende vraag
...
function finishQuiz() {
  ...
  quizWrapper.style.background = "#333a41";
  quizWrapper.style.color = "white";
  resultBox.innerHTML = "<h2>Goed gedaan! <br> <br> Goede antwoorden: " + playerData.goodAnswers + "<br>Foute antwoorden: " + playerData.wrongAnswers + "</h2> <br> Stuur deze quiz door naar anderen en maak kans op een prijs! ";
}
